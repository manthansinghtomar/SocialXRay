...
const GlowCard = ({ children, className = '', innerClassName = '', delay = 0 }) => {
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-xl border border-slate-900 bg-slate-950/40 p-8 backdrop-blur-md transition-all duration-300 hover:border-indigo-500/20 group ${className}`}
    >
